...
<div class="container " style="  padding-bottom: 81px; min-height: calc(100% - 81px); position: relative;">
    ...
    <form class="d-flex" action="SvBuscarOrdenar" method="POST">
        ...
        <input class="form-control me-2" name="buscarTabla" type="search" placeholder="  Busca tu libro" aria-label="Search"style="-moz-border-radius: 10px; -webkit-border-radius: 40px; border-radius: 40px;border: 1px solid #000000; height: 40px;padding: 0 4px 0 4px;">
...
<script>
    $(document).ready(function () {
        ...
        $('[data-bs-toggle="ver"]').on('click', function () {
            ...
            $.ajax({
                url: 'SvAnadirVer?id=' + id, // URL del servlet o recurso que maneja la solicitud
                method: 'GET',
        ...
        button.addEventListener("click", function () {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "SvEliminarEditar?id=" + encodeURIComponent(id);
