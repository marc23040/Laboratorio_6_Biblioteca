    ...
    <div class="col-sm">
        ...
        padding: 0 4px 0 4px;">
            ...
            <button class="btn btn-outline-success" type="submit" style=
                    " background-color: #5e3824;-moz-border-radius: 10px; border-radius: 50%; -webkit-border-radius: 60px;margin-left: 10px;">
...
">
   ...
   <div class="row" style="align-items: center; justify-content: center;">
       ...
       <div class="col" style="padding: 2rem; align-items: center; justify-content: center;">
           ...
           <a href="biblioteca.jsp" class="btn btn-outline-success" style=
              " display: flex;align-items: center; justify-content: center;background-color: #5e3824;-moz-border-radius: 10px; 
              border-radius: 50%; -webkit-border-radius: 60px;margin-top: 30px; width: 200px; height: 50px;s">Mirar todo</a>
       </div>
