...
<!-- Pie de página -->
<br>
<footer style="background-color: #5e3824; margin-left: -0px; margin-right: -0px; margin-top: 30px; position: absolute; bottom: 0; width: 100%;">
    ...
    <div class="container d-flex justify-content-between align-items-center flex-wrap">
        ...
        <!-- Texto central del pie de página -->
